...
// normal routes ===============================================================
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
        bookCollection.find().toArray((err, result) => {
          ...
          let myBooks = result.filter(book => book.email === req.user.local.email)
...
// message board routes ===============================================================
    let bookCollection = db.collection('book-log')
    ...
    app.put('/books', (req, res) => {
      bookCollection.findOneAndUpdate({title: req.body.title}, {
        $set: {
          progress:req.body.progress + 5
        }
      }, {
        sort: {_id: -1},
        upsert: true
    ...
    app.delete('/deleteBook', (req, res) => {
      bookCollection.findOneAndDelete({title: req.body.title}, (err, result) => {
